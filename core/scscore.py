...
class SCScorer():
    ...
    def restore(self, weight_path=os.path.join('save_folder/scscore_model', 'full_reaxys_model_1024bool', 'model.ckpt-10654.as_numpy.json.gz'), FP_rad=FP_rad, FP_len=FP_len):
